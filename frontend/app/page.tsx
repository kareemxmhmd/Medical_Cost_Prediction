...
export default function MedicalCostPredictor() {
  ...
  const apiUrl =
    process.env.NEXT_PUBLIC_API_URL?.replace(/\/$/, "") || "https://medicalcostprediction-production.up.railway.app";
  const apiKey =
    ...
    <div className="min-h-screen py-10 px-4 sm:px-6 lg:px-8">
      <div className="max-w-4xl mx-auto">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-start">
          {/* Form Column */}
          <div className="lg:col-span-6 bg-white rounded-2xl border border-slate-300 shadow-sm p-6 sm:p-8">
          ...
          <div className="lg:col-span-6 space-y-6">
            ...
            {result && (
              <div ref={resultRef} className="bg-white rounded-2xl border border-slate-300 shadow-sm p-6 sm:p-8 space-y-6">
                {/* Header status */}
                ...
                <div className="pt-2 border-t border-slate-100 flex items-center justify-between text-xs text-slate-400">
                  ...
                  <button
                    onClick={handleReset}
                    className="px-3 py-1.5 border border-slate-300 rounded-md text-slate-600 hover:bg-slate-50 font-medium transition-colors"
                  >
